        ...
        <div class="row">
          <div class="col-lg-8">
            <ul class="nav nav-pills">
              <li class="nav-item"><a href="checkout1.php" class="nav-link active">Address</a></li>
            ...
            <div class="tab-content">
              <div id="address" class="active tab-block">
                <form action="#">
                  ...
                  <!-- /Shipping Address-->
                  <div class="CTAs d-flex justify-content-between flex-column flex-lg-row"><a href="cart.php" class="btn btn-template-outlined wide prev"> <i class="fa fa-angle-left"></i>Back to basket</a><a href="checkout2.php" class="btn btn-template wide next">Choose delivery method<i class="fa fa-angle-right"></i></a></div>
                </form>
              </div>
            </div>
          </div>
