          ...
          <div class="col-lg-8">
            ...
            <div class="tab-content">
              <div id="delivery-method" class="tab-block">
                ...
                <div class="CTAs d-flex justify-content-between flex-column flex-lg-row"><a href="checkout1.php" class="btn btn-template-outlined wide prev"><i class="fa fa-angle-left"></i>Back to Address</a><a href="checkout3.php" class="btn btn-template wide next">Choose payment method<i class="fa fa-angle-right"></i></a></div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
